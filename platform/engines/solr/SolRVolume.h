...
{
public:
    SolRVolume(const Vector3ui& dimensions, const Vector3f& spacing, const DataType type, VolumeParameters& params,
               SolRTransferFunction& transferFunction, const std::string& volumeType);
    ~SolRVolume();
...
{
public:
    SolRBrickedVolume(const Vector3ui& dimensions, const Vector3f& spacing, const DataType type,
...
{
public:
    SolRSharedDataVolume(const Vector3ui& dimensions, const Vector3f& spacing, const DataType type,
                         VolumeParameters& params, SolRTransferFunction& transferFunction);
